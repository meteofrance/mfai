...
| :---:   | :---: | :---: | :---: | :---: | :---: |
| [DeepLabV3Plus](https://github.com/meteofrance/mfai/blob/main/mfai/pytorch/models/deeplabv3.py#L1) | [arxiv link](https://arxiv.org/abs/1802.02611) | (Batch, features, Height, Width)    | Yes | As a very large receptive field versus U-Net, Half-Unet, ... | Front Detection, Nowcasting |
...
Check the code of [onnx_load_and_infer](https://github.com/meteofrance/mfai/blob/main/mfai/pytorch/__init__.py#L35) if you would like to load the model once and make multiple inferences.
